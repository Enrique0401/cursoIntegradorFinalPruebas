...
//        botonRegresar.setBackground(new Color(30, 45, 65));
    ...
    private void botonActualizarDatos1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActualizarDatos1ActionPerformed
        TablaSeguimientos tablaProy = new TablaSeguimientos();
        tablaProy.setSize(797, 537);
        tablaProy.setLocation(0, 0);

        contenedor.removeAll();
        contenedor.add(tablaProy, BorderLayout.CENTER);
        contenedor.revalidate();
        contenedor.repaint();
